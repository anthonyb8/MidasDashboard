            ...
            <table className='parameters-table'>
                <tbody>
                    <tr className='parameters-table-row'>
                        ...
                        <td className='parameters-table-data'>BENCHMARK</td>
                        <td className='parameters-table-data'>{parameters.benchmark}</td>
                    </tr>
                    <tr className='parameters-table-row'>
                    ...
                    <tr className='parameters-table-row'>
                        ...
                        <td className='parameters-table-data'>{convertUnixNanosecondsToISO(parameters.train_start)}</td>
                        <td className='parameters-table-data'>TRAIN END</td>
                        <td className='parameters-table-data'>{convertUnixNanosecondsToISO(parameters.train_end)}</td>
                    </tr>
                    <tr className='parameters-table-row'>
                        <td className='parameters-table-data'>TEST START</td>
                        <td className='parameters-table-data'>{convertUnixNanosecondsToISO(parameters.test_start)}</td>
                        <td className='parameters-table-data'>TEST END</td>
                        <td className='parameters-table-data'>{convertUnixNanosecondsToISO(parameters.test_end)}</td>
                    </tr>
                </tbody>
            </table>
        </div>
