      ...
      <table className='regression-table'>
        <thead>
          <tr className='regression-table-row'>
            <th className='regression-table-header'>RISK</th>
            <th className='regression-table-header'>&nbsp;</th>
            <th className='regression-table-header'>&nbsp;</th>
            <th className='regression-table-header'>&nbsp;</th>
          </tr>
        </thead>
        <tbody>
          {transformed_data.map((row, index) => (
            <tr className='regression-table-row' key={index}>
              <td className='regression-table-data'>{row.key1.replace(/_/g, " ")}</td>
              <td className='regression-table-data'>{row.value1}</td>
              <td className='regression-table-data'>{row.key2.replace(/_/g, " ")}</td>
